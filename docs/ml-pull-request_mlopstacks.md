...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_dbx-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-0f89edfa-de75.cloud.databricks.com/explore/data/models/staging/mlops_dbx/mlops_dbx-model)
* [Prod model in UC](https://dbc-0f89edfa-de75.cloud.databricks.com/explore/data/models/prod/mlops_dbx/mlops_dbx-model)
. 
