...
git add README.md docs .gitignore mlops_dbx/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-0f89edfa-de75.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-0f89edfa-de75.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[mlops_dbx/databricks.yml](../mlops_dbx/databricks.yml) file.
...
Follow the instructions in [mlops_dbx/resources/README.md](../mlops_dbx/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_dbx/resources/README.md)  to propose, test, and deploy
